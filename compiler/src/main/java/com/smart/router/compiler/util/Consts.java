...
public class Consts {
    ...
    public static final String PACKAGE_NAME = "com.smart.router.router";
    ...
    public static final String ROUTE_ANNOTATION_TYPE = "com.smart.router.annotation.Route";
    public static final String INTERCEPTOR_ANNOTATION_TYPE = "com.smart.router.annotation.Interceptor";
    public static final String PARAM_ANNOTATION_TYPE = "com.smart.router.annotation.InjectParam";
