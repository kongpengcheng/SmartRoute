...
import static com.smart.router.compiler.util.Consts.INTERCEPTOR_ANNOTATION_TYPE;
import static com.smart.router.compiler.util.Consts.INTERCEPTOR_INTERFACE;
import static com.smart.router.compiler.util.Consts.INTERCEPTOR_TABLE;
